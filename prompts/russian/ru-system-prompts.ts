...
*   **Практические задания:** "BOOK.GLVRD.RU/PRACTICE"
*   **Читайте советы:** "GLVRD.RU/SOVIET"
*   **Проверяйте текст в Главреде:** "GLVRD.RU"
*   **Делитесь мыслями, критикой и наблюдениями:** "book@glvrd.ru"
